...
class CodableFeedStoreTests: XCTestCase {
  ...
  func test_delete_hasNoSideEffectsOnEmptyCache() {
    ...
    XCTAssertNil(deletionError, "Expected non-empty cache deletion succeed")
    expect(sut, toRetrieve: .empty)
  }
  ...
  func test_storeSideEffects_runSerially() {
    ...
    XCTAssertEqual(completedOperationsInOrder, [op1, op2, op3], "Expected side-effectes to run serially but operations finished in the wrong order")
  }
