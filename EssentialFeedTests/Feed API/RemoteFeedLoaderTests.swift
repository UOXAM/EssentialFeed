...
class RemoteFeedLoaderTests: XCTestCase {
  ...
  func test_load_deliversErrorOn200HTTPResponseWithInvalidJSON() {
    ...
    expect(sut, toCompleteWith: .failure(RemoteFeedLoader.Error.invalidData), when: { let invalidJSON = Data(_: "invalid json".utf8)
  ...
  func test_load_deliversItemsOn200HTTPResponseWithJSONItems() {
    ...
    let item1 = makeItem(
      id: UUID(),
      imageURL: URL(string: "http://a_url.com")!)
        
    let item2 = makeItem(
      id: UUID(),
      description: "a desciption",
      location: "a location",
      imageURL: URL(string: "http://another_url.com")!)
